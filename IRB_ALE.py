...
# De la tabla
T01 = T.subs({d: 0.290, a: 0, alpha: sp.pi/2, theta: theta1})
sp.pprint(T01)
T12 = T.subs({d: 0, a: 0.27, alpha: 0, theta: theta2})
sp.pprint(T12)
T23 = T.subs({d: 0, a: 0.07, alpha: sp.pi/2, theta: theta3})
sp.pprint(T23)
T34 = T.subs({d: 0.302, a: 0, alpha: -sp.pi/2, theta: theta4})
sp.pprint(T34)
T45 = T.subs({d: 0, a: 0, alpha: sp.pi/2, theta: theta5})
sp.pprint(T45)
T56 = T.subs({d: 0.072, a: 0, alpha: 0, theta: theta6})
sp.pprint(T56)
