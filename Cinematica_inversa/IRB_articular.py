...
q_list_deg = [
    np.array([-23.68, 63.63, 38.12, 155.87, 100.74, -184.77]),
    np.array([-23.68, 14.50, 52.74, 154.56, 69.25, -170.44]),
    np.array([-23.68, 14.50, 52.74, 25.44, -69.25, -9.56]),
    np.array([-23.68, 63.63, 38.12, 24.13, -100.74, 4.77]),
    np.array([-23.68, 63.63, 38.12, 24.13, -100.74, -4.77]),
    np.array([-13.15, 76.22, -8.06, -14.13, -68.77, 5.21]),
    np.array([-13.15, 44.46, 4.71, -17.16, -50.45, 11.12]),
    np.array([13.15, 44.46, 4.71, 17.16, -50.45, -11.12]),
    np.array([13.15, 76.22, -8.06, 14.13, -68.77, -5.21]),
    np.array([-13.15, 76.22, -8.06, -14.13, -68.77, 5.21]),
    np.array([-13.15, 44.46, 4.71, -17.16, -50.45, 11.12]),
