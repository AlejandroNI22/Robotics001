...
q_list_deg = [
    np.array([12.80, 6.73, -71.97, -13.44, 72.44, 4.12]),
    np.array([12.80, -27.70, -18.34, -35.84, 22.24, 33.77]),
    np.array([48.65, -6.27, -24.67, -69.83, 53.11, 58.54]),
    np.array([48.65, 19.89, -65.50, -51.31, 74.10, 18.89]),
    np.array([12.80, 6.73, -71.97, -13.44, 72.44, 4.12]),
    np.array([6.79, 30.12, -57.97, -7.99, 58.22, 4.23]),
    np.array([6.79, 9.27, -24.25, -16.16, 25.13, 14.70]),
    np.array([30.76, 20.32, -21.40, -58.49, 36.87, 52.54]),
    np.array([30.76, 37.92, -51.49, -37.26, 57.65, 22.15]),
    np.array([6.79, 30.12, -57.97, -7.99, 58.22, 4.23]),
    np.array([6.79, 9.27, -24.25, -16.16, 25.13, 14.70]),
    np.array([12.80, -27.70, -18.34, -35.84, 22.24, 33.77]),
    np.array([48.65, -6.27, -24.67, -69.83, 53.11, 58.54]),
